...
indirect enum Token: Hashable {
    ...
    /// Represents a Zil part-of-speech "first" value.
    case partsOfSpeechFirst(String)
...
extension Token {
    ...
    public var value: String {
        ...
        case .partsOfSpeechFirst(let value): return "\(value)"
...
extension Token: CustomStringConvertible {
    ...
    var description: String {
        ...
        case .partsOfSpeechFirst(let value): return ".partsOfSpeechFirst(\(value))"
    ...
    var zil: String {
        ...
        case .partsOfSpeechFirst(let value): return ",P1?\(value)"
